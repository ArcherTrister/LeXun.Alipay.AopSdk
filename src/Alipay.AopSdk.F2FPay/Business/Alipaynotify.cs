...
namespace Alipay.AopSdk.F2FPay.Business
{
    ...
    public class Notify
    {
        ...
        private readonly string _charset = "";         //编码格式
        private readonly string _sign_type = "";             //签名方式
        private readonly string _alipay_public_key = "";     //支付宝公钥文件地址

        //支付宝消息验证地址
        private readonly string Https_veryfy_url = "";
