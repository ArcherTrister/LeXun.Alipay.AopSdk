...
组件名  | 说明 | 版本号 
-------- | :------------  | :------------ 
Alipay.AopSdk.Core | 服务端SDK，封装了支付宝开放平台的所有API  |  [![Latest version](https://img.shields.io/nuget/v/LeXun.Alipay.AopSdk.Core.svg)](https://www.nuget.org/packages/LeXun.Alipay.AopSdk.Core/)
Alipay.AopSdk.F2FPay.Core  | 当面付SDK，提供条码支付、扫码支付能力  | [![Latest version](https://img.shields.io/nuget/v/LeXun.Alipay.AopSdk.F2FPay.Core.svg)](https://www.nuget.org/packages/LeXun.Alipay.AopSdk.F2FPay.Core/) 
Alipay.AopSdk.AspnetCore  | 服务端SDK的ASP.NET Core组件，为了能更好配合ASP.NET Core 使用  | [![Latest version](https://img.shields.io/nuget/v/LeXun.Alipay.AopSdk.AspnetCore.svg)](https://www.nuget.org/packages/LeXun.Alipay.AopSdk.AspnetCore/) 
Alipay.AopSdk.F2FPay.AspnetCore  | 当面付SDK的ASP.NET Core组件，为了能更好配合ASP.NET Core 使用  | [![Latest version](https://img.shields.io/nuget/v/LeXun.Alipay.AopSdk.F2FPay.AspnetCore.svg)](https://www.nuget.org/packages/LeXun.Alipay.AopSdk.F2FPay.AspnetCore/) 
...
````
Install-Package Install-Package LeXun.Alipay.AopSdk.AspnetCore
````
...
````
Install-Package LeXun.Alipay.AopSdk.F2FPay.AspnetCore
````
